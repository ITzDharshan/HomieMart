...
<body>
  <header class="main-section">
    <video autoplay muted loop class="background-video">
        <source src="videos/Knitting.mp4" type="video/mp4">
  ...
  <section class="community-section">
    <div class="content">
      ...
      <p>
        Explore the timeless craft of knitting and crochet with our carefully curated selection of high-quality yarns, tools, and accessories. Whether you're just starting out or are a seasoned crafter, our range offers everything you need to create beautiful and cozy handmade pieces. From soft, vibrant yarns to ergonomic hooks and needles, we provide the essentials to make every stitch a delight. Join our community to access helpful patterns, expert techniques, and creative project ideas to inspire your next knitting or crochet adventure. Whether you're making a warm scarf, intricate blanket, or unique accessories, our products and resources are here to support your crafting journey every step of the way.   
      </p>
  ...
  <?php
    ...
    $description = 'Woolen clothing, blankets, and accessories.';
