...
if (isset($_GET['delete_message'])) {
    ...
    if ($delete_result) {
        echo "<script>alert('Message deleted successfully!'); window.location.href='WP_message.php';</script>";
    } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($update->execute()) {
        echo "<script>alert('Reply message updated successfully!'); window.location.href='WP_message.php';</script>";
    } else {
        echo "<script>alert('Error: " . $update->error . "'); window.location.href='WP_message.php';</script>";
    }
}
?>
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h1>Wellness Products Makers Message Section</h1>
				</div>
			</div>
