...
<body>
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h1>Artist / Painters Order History</h1>
				</div>
			</div>
								...
								while ($row = mysqli_fetch_assoc($result)) {
									...
									echo "<td>
											<div class='custom-select'>
												<div class='select-selected'> Select <i class='bx bxs-chevron-down-square'></i></div>
    ...
    options.forEach(function(option) {
        option.addEventListener('click', function() {
            ...
            selectSelected.className = 'select-selected'; // Reset class
            selectSelected.classList.add(option.dataset.value.toLowerCase()); // Add status class
