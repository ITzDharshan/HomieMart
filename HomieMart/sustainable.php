...
<body>
  <header class="main-section">
    <video autoplay muted loop class="background-video">
        <source src="videos/sustainable.mp4" type="video/mp4">
  ...
  <section class="community-section">
    <div class="content">
      ...
      <p>
        Embrace a greener lifestyle with our wide range of sustainable products, designed to make eco-friendly living effortless and impactful. From reusable alternatives and biodegradable essentials to energy-efficient solutions, our collection empowers you to make choices that benefit both you and the planet. Whether you’re starting small with everyday swaps or fully committing to a zero-waste lifestyle, we’re here to support your journey. Join our community to learn practical sustainability tips, explore innovative products, and connect with like-minded individuals who share your passion for protecting the environment. Together, we can create a healthier, more sustainable future—one choice at a time.  
      </p>
  ...
  <?php
    ...
    $description = 'Eco-friendly bags and reusable household items.';
