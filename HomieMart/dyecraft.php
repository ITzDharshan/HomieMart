...
<body>
  <header class="main-section">
    <video autoplay muted loop class="background-video">
        <source src="videos/dyecraft.mp4" type="video/mp4">
  ...
  <section class="community-section">
    <div class="content">
      ...
      <p>
        Discover the magic of Dye Craft and the world of hand-dyed fabrics and artistic creations. 
        Our community is a vibrant space where artists, crafters, and enthusiasts come together to share their passion for unique craftsmanship. 
        By joining, you'll gain access to exclusive resources, tips, and tutorials that help you master the art of dyeing and fabric design. 
        Connect with like-minded individuals, exchange ideas, and get inspired by stunning works of art. 
        Whether you're a seasoned artist or just starting your journey, our community is the perfect place to grow and showcase your creativity.   
      </p>
  ...
  <?php
    $category = 'Dye Crafts';
    $description = 'Hand-dyed fabrics and artistic creations.';
