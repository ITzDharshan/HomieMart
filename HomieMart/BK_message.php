...
if (isset($_GET['delete_message'])) {
    ...
    if ($delete_result) {
        echo "<script>alert('Message deleted successfully!'); window.location.href='BK_message.php';</script>";
    } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($update->execute()) {
        echo "<script>alert('Reply message updated successfully!'); window.location.href='BK_message.php';</script>";
    } else {
        echo "<script>alert('Error: " . $update->error . "'); window.location.href='BK_message.php';</script>";
    }
}
?>
