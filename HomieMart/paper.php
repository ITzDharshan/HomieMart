...
<body>
  <header class="main-section">
    <video autoplay muted loop class="background-video">
        <source src="videos/paper.mp4" type="video/mp4">
    ...
    <div class="dyecraft-head">
        <h1>Stationery and Paper Crafts</h1>
    </div>
  </header>
  ...
  <section class="community-section">
    <div class="content">
      ...
      <p>
        Unleash your creativity with our extensive collection of stationery and paper crafts supplies, perfect for crafters, artists, and planners alike. From beautifully textured papers and vibrant markers to decorative stickers, stamps, and tools, we have everything you need to bring your ideas to life. Whether you're creating personalized cards, scrapbooking your memories, or organizing your life with stylish planners, our products offer endless possibilities for artistic expression. Join our community to discover fun DIY projects, tips, and inspiration to help you craft unique, handmade treasures. Let your imagination run wild with our premium stationery and paper craft essentials, and make every creation special.   
      </p>
  ...
  <?php
    $category = 'Stationery and Paper Crafts';
    $description = 'Greeting cards, journals, and bookmarks.';
...
<footer class="footer">
    <div class="footer-about">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla quam velit, vulputate eu pharetra nec, 
            mattis ac neque. Donec dapibus fermentum risus, at ultrices mi molestie sed.</p>
    </div>
